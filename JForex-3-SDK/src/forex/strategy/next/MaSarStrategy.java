...
public class MaSarStrategy implements IStrategy {
	...
	public void onBar(Instrument instrument, Period period, IBar askBar, IBar bidBar) throws JFException {
		...
		if (((longMA[4] - shortMA[4] <= 50)) && (longMA[0] - shortMA[0]) > (longMA[1] - shortMA[1])
				&& (longMA[1] - shortMA[1]) > (longMA[2] - shortMA[2])
		...
		if (((shortMA[4] - longMA[4]) <= 50) && (shortMA[0] - longMA[0]) > (shortMA[1] - longMA[1])
				&& (shortMA[1] - longMA[1]) > (shortMA[2] - longMA[2])
